...
ActiveRecord::Schema.define(version: 20161128120104) do
  ...
  create_table "histories", force: :cascade do |t|
    ...
    t.index ["intent_id"], name: "index_histories_on_intent_id", using: :btree
  ...
  add_foreign_key "histories", "intents"
  add_foreign_key "intents", "bots"
